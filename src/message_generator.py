...
class MessageGenerator:
    ...
    def __init__(self, message_type: str, message: str) -> None:
        self.version = "2024.08.12"  # TODO: Replace with a method that gets the current version dynamically
    ...
    def deserialize(data: bytes) -> dict:
        '''
        Deserializes bytes back into a message dictionary.
...
if __name__ == '__main__':
    msg_gen = MessageGenerator(
        message_type="JobRequest",
        message='CoChain:Pages, Type: Storage, Resource:UndChain'
    )
